...
public class PortfolioActivityClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_portfolio_class);
    ...
    private void displayDailyAccuracies() {
        ...
        firestore.collection("daily_accuracies_class")
    ...
    private void fetchPredictions() {
        db.collection("predictions_class").document("latest")
    ...
    private void fetchDailyChanges() {
        ...
        db.collection("daily_changes_class")
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(PortfolioActivityClass.this, "Error fetching daily changes", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void fetchAndDisplayAccuracyData() {
        ...
        db.collection("daily_accuracies_class")
                .document(portfolio)
    ...
    private void displayAccuracyBarChart(List<BarEntry> accuracyEntries, List<String> labels) {
        ...
        barChartAccuracy.getLegend().setForm(LegendForm.CIRCLE);
